            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 ">
              <div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                <div class="pattern-dots-md gray-light">
                  <div class="rounded border-2 shadow-lg p-4 transform translate-x-6 -translate-y-6  ">
        ...
        <section class="">
          <div class="max-w-6xl mx-auto px-5 py-24 ">
            <div class="text-center mb-20">
              ...
              <div class="flex mt-6 justify-center">
                <div class="w-32 h-1 rounded-full bg-purple-500 inline-flex"></div>
              </div>
            </div>
            <div class="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
              <div class="card min-w-fit bg-base-100 shadow-xl">
                <div class="card-body">
                  <h2 class="card-title">KhabarChai.com</h2>
                  <p>
              ...
              <div class="card min-w-fit  bg-base-100 shadow-xl">
                <div class="card-body">
                  <h2 class="card-title">Dream Photography</h2>
                  <p>
              ...
              <div class="card min-w-fit  bg-base-100 shadow-xl">
                <div class="card-body">
                  <h2 class="card-title">Review Loader</h2>
                  <p>
